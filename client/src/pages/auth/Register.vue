...
const handleRegister = async () => {
  ...
  try {
    ...
    success.value = 'Account created! Check your email for a verification code.'
    step.value = 'verify'
  } catch (err: any) {
...
const handleVerify = async () => {
  ...
  try {
    ...
    success.value = 'Email verified successfully! Logging you in...'
    setTimeout(() => {
  ...
  <div class="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 flex items-center justify-center px-6 py-12">
    <div class="w-full max-w-md space-y-8">
      ...
      <div class="space-y-2 text-center">
        ...
        <h1 v-if="step === 'register'" class="text-3xl font-bold text-white">Create account</h1>
        <h1 v-else class="text-3xl font-bold text-white">Verify your email</h1>
        <p class="text-gray-400">
          <span v-if="step === 'register'">Join us and start managing your subscriptions</span>
          <span v-else>Enter the verification code sent to {{ registeredEmail }}</span>
        </p>
      </div>
        ...
        <form @submit.prevent="handleVerify" class="space-y-6">
          ...
          <div class="space-y-2">
            ...
            <input
              ...
              maxlength="6"
              inputmode="numeric"
              class="w-full px-4 py-3 rounded-lg bg-gray-800 border border-gray-700 text-white placeholder-gray-500 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition duration-200 text-center text-2xl font-mono tracking-widest"
              required
            />
          ...
          <button
            ...
            class="w-full px-4 py-3 rounded-lg border border-gray-700 text-gray-400 hover:text-white hover:border-gray-600 font-semibold transition-all duration-300"
          >
            Back to Register
          </button>
        </form>
      ...
      <!-- Login Link -->
      <p v-if="step === 'register'" class="text-center text-gray-400 text-sm">
